...
/***/ function(module, exports, __webpack_require__) {
	...
	var CounterApp = function CounterApp(_ref) {
	...
	var tree = CounterApp({ count: count, increment: increment });
	var rootNode = (0, _virtualDom.createElement)(tree);
	document.body.appendChild(rootNode);

	function increment() {
	  count += 1;

	  var newTree = CounterApp({ count: count, increment: increment });
